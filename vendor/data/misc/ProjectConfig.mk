...
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw gc8034_mipi_raw_sub
...
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw_sub
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw gc8034_mipi_raw_sub
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034_mipi_raw_sub
...
CUSTOM_MODEM= JY902I_YZ_G2358_W18_FDD3540_V58.5
...
#joyar-wangshengyuan set no for not support WMA and cts fail.
...
MTK_FINGERPRINT_CUSTOM_SUPPORT = yes
MTK_FINGERPRINT_BF3390 = no
MTK_FINGERPRINT_MICROARRAY = no
MTK_FINGERPRINT_SUNWAVE = yes
MTK_FINGERPRINT_FPS988E = no
MTK_FINGERPRINT_CHIPSAILING_CS1501 = no

#wangshengyuan add for custom shutdown animation
CUSTOM_BOOTANIMATION_SUPPORT=yes

#joya GMS BUILD start
BUILD_GMS = yes
BUILD_AGO_GMS = no
BUILD_GMS_WITH_FASTPASS = yes
#joya GMS BUILD end

JOYAR_SYSTEM_FOTA_SUPPORT = yes

JOYAR_OTG_SUPPORT=yes

# NXP nfc
MTK_NFC_NXP_SUPPORT = no
